...
def get_predict_spectrum_figure(
    ...
    energy_x, dn_de_y0 = plot_sens_spectrum_figure(
        sigma_bg,
        alpha, t_obs_est[0], a_eff_interpol, n_points_to_plot=n_points_to_plot, e_0=e_0, fmt='k:'
        )
    __a, dn_de_y1 = plot_sens_spectrum_figure(
        sigma_bg,
        alpha, t_obs_est[1], a_eff_interpol, n_points_to_plot=n_points_to_plot, e_0=e_0, fmt='k'
        )
    __a, dn_de_y2 = plot_sens_spectrum_figure(
        sigma_bg,
        alpha, t_obs_est[2], a_eff_interpol, n_points_to_plot=n_points_to_plot, e_0=e_0, fmt='k:'
        )
